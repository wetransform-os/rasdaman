...
mvn -q clean && mvn -q package > $OUTPUT_DIR/mvn_package.log 2>&1
...
java -jar test_web_interfaces-spring-boot.jar $PETASCOPE_PORT $SECORE_PORT > $OUTPUT_DIR/test.log 2>&1
result="$?"
