...
public class ExceptionCode {
    ...
    public static final ExceptionCode InternalComponentError = new ExceptionCode("InternalComponentError", SC_INTERNAL_SERVER_ERROR);
    public static final ExceptionCode InternalSqlError = new ExceptionCode("InternalSqlError", SC_INTERNAL_SERVER_ERROR);
    ...
    public static final ExceptionCode InterpolationMethodNotSupported = new ExceptionCode("InterpolationMethodNotSupported",
            "'interpolation' parameter indicated is not supported by this server (i.e., URL is not known to this server).", SC_NOT_IMPLEMENTED, "interpolation");
    ...
    public static final ExceptionCode InvalidMetadata = new ExceptionCode("InvalidMetadata", SC_INTERNAL_SERVER_ERROR);
    ...
    public static final ExceptionCode InvalidPropertyValue = new ExceptionCode("InvalidPropertyValue", SC_INTERNAL_SERVER_ERROR);
    public static final ExceptionCode InvalidRequest = new ExceptionCode("InvalidRequest", SC_BAD_REQUEST);
    public static final ExceptionCode InvalidCredentials = new ExceptionCode("InvalidCredentials", "Credentials are invalid.", SC_UNAUTHORIZED);
    public static final ExceptionCode AccessDenied = new ExceptionCode("AccessDenied", "Access denied, no permission to perform request", SC_FORBIDDEN);
    ...
    public static final ExceptionCode IOConnectionError = new ExceptionCode("IOConnectionError", SC_INTERNAL_SERVER_ERROR);
    public static final ExceptionCode MaliciousQuery = new ExceptionCode("MaliciousQuery", SC_BAD_REQUEST);
    public static final ExceptionCode MissingPropertyKey = new ExceptionCode("MissingPropertyKey", SC_BAD_REQUEST);
    ...
    public static final ExceptionCode RasdamanRequestFailed = new ExceptionCode("RasdamanRequestFailed", SC_INTERNAL_SERVER_ERROR);
    public static final ExceptionCode RasdamanUnavailable = new ExceptionCode("RasdamanUnavailable", SC_SERVICE_UNAVAILABLE);
    public static final ExceptionCode OutOfMemory = new ExceptionCode("OufOfMemory", SC_SERVICE_UNAVAILABLE);
    public static final ExceptionCode RasdamanError = new ExceptionCode("RasdamanError", SC_INTERNAL_SERVER_ERROR);
    public static final ExceptionCode ResolverError = new ExceptionCode("ResolverError", SC_INTERNAL_SERVER_ERROR);
    public static final ExceptionCode ResourceError = new ExceptionCode("ResourceError", SC_INTERNAL_SERVER_ERROR);
    ...
    public static final ExceptionCode XmlNotValid = new ExceptionCode("XmlNotValid", SC_BAD_REQUEST);
    public static final ExceptionCode XmlStructuresError = new ExceptionCode("XmlStructuresError", SC_BAD_REQUEST);
    public static final ExceptionCode WcpsError = new ExceptionCode("WcpsError", SC_INTERNAL_SERVER_ERROR);
    public static final ExceptionCode WcsError = new ExceptionCode("WcsError", SC_INTERNAL_SERVER_ERROR);
    ...
    public static final ExceptionCode WCSTMissingCoverageParameter = new ExceptionCode("WCSTMissingCoverageParameter",
            "No \"coverage\" of \"coverageRef\" parameters were found in the request (at least one expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTUnknownUseId = new ExceptionCode("WCSTUnknownUseId",
            "Unknown value of the useId parameter(expecting one of \"existing\" or \"new\").", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTMalformedURL = new ExceptionCode("WCSTMalformedURL",
            "The URL provided in the coverageRef parameter is malformed.", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTMissingBoundedBy = new ExceptionCode("WCSTMissingBoundedBy",
            "The coverage contains wrong number of \"" + XMLSymbols.LABEL_BOUNDEDBY + "\" elements (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTMissingEnvelope = new ExceptionCode("WCSTMissingEnvelope",
            "The coverage contains wrong number of \"" + XMLSymbols.LABEL_ENVELOPE + "\" elements (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTMissingDomainSet = new ExceptionCode("WCSTMissingDomainSet",
            "The coverage contains wrong number of \"" + XMLSymbols.LABEL_DOMAIN_SET + "\" elements (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTMissingGridType = new ExceptionCode("WCSTMissingGridType",
            "The \"" + XMLSymbols.LABEL_DOMAIN_SET + "\" element contains the wrong number of grid types (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTMissingLimits = new ExceptionCode("WCSTMissingLimits",
            ...
            XMLSymbols.LABEL_LIMITS + "\" (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTMissingGridEnvelope = new ExceptionCode("WCSTMissingGridEnvelope",
            ...
            XMLSymbols.LABEL_GRID_ENVELOPE + "\" (exactly 1 expected).", SC_BAD_REQUEST);
    ...
    public static final ExceptionCode WCSTMissingPoint = new ExceptionCode("WCSTMissingPoint",
            ...
            XMLSymbols.LABEL_POINT + "\" (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTMissingPos = new ExceptionCode("WCSTMissingPos",
            "The \"" + XMLSymbols.LABEL_ORIGIN + "\" element contains the wrong number of \"" +
            XMLSymbols.LABEL_POS + "\" (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTWrongNumberOfOffsetVectors = new ExceptionCode("WCSTWrongNumberOfOffsetVectors",
            "The number of \"" + XMLSymbols.LABEL_OFFSET_VECTOR + "\" elements is different from the number of axes", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTWrongInervalFormat = new ExceptionCode("WCSTWrongIntervalFormat",
            ...
            + "(exactly 2 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTWrongNumberOfTupleLists = new ExceptionCode("WCSTWrongNumberOfTupleLists",
            "The number of \"" + XMLSymbols.LABEL_TUPLELIST + "\" elements is wrong (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTWrongNumberOfPixels = new ExceptionCode("WCSTWrongNumberOfPixels",
            "The number of pixels provided in the \"" + XMLSymbols.LABEL_TUPLELIST + "\" element doesn't correspond to the coverage size", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTWrongNumberOfRangeSetElements = new ExceptionCode("WCSTWrongNumberOfRangeSetElements",
            "The number of \"" + XMLSymbols.LABEL_RANGESET + "\" elements is wrong (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTWrongNumberOfDataBlockElements = new ExceptionCode("WCSTWrongNumberOfDataBlockElements",
            "The number of \"" + XMLSymbols.LABEL_DATABLOCK + "\" elements is wrong (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTWrongNumberOfFileElements = new ExceptionCode("WCSTWrongNumberOfFileElements",
            "The number of \"" + XMLSymbols.LABEL_FILE + "\" elements is wrong (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTWrongNumberOfFileReferenceElements = new ExceptionCode("WCSTWrongNumberOfFileReferenceElements",
            "The number of \"" + XMLSymbols.LABEL_FILE_REFERENCE + "\" elements is wrong (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTWrongNumberOfFileStructureElements = new ExceptionCode("WCSTWrongNumberOfFileStructureElements",
            "The number of \"" + XMLSymbols.LABEL_FILE_STRUCTURE + "\" elements is wrong (exactly 1 expected).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTDuplicatedCoverageId = new ExceptionCode("WCSTDuplicatedCoverageName",
            "A coverage with this name already exists (pick a different name or use the request parameter useId=new).", SC_BAD_REQUEST);
    public static final ExceptionCode WCSTTypeRegistryNotFound = new ExceptionCode("WCSTTypeRegistryNotFound",
            "Could not read the rasdaman type registry.", SC_INTERNAL_SERVER_ERROR);
    public static final ExceptionCode WCSTOnlyRectifiedGridsSupported = new ExceptionCode("WCSTOnlyRectifiedGridsSupported",
            "Only rectified grids are supported in the domainSet element.", SC_BAD_REQUEST);

    public static final ExceptionCode InconsistentChange = new ExceptionCode("InconsistentChange", SC_NOT_FOUND);
    public static final ExceptionCode CollectionExists = new ExceptionCode("CollectionExists", "Collection name already exists in rasdaman.", SC_BAD_REQUEST);
    public static final ExceptionCode CollectionDoesNotExist = new ExceptionCode("CollectionDoesNotExist", "Collection name does not exist in rasdaman.", SC_BAD_REQUEST);

    // WCS 2 Exception code (InvalidRequest returns error 400 but in some cases OGC CITE wants error 404 for WCS 2.0.1)
    public static final ExceptionCode WCSBadRequest = new ExceptionCode("WCSBadRequest", SC_NOT_FOUND);
