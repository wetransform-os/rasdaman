...
import petascope.wcps.parser.wcpsParser;
...
public class DimensionIntervalListHandler extends Handler {
    
    public DimensionIntervalListHandler() {
        
    }
    
    public DimensionIntervalListHandler create(List<Handler> childHandlers) {
        DimensionIntervalListHandler result = new DimensionIntervalListHandler();
