...
public:
    ...
    std::uint32_t getMaxClientQueueSize() const;
    void setMaxClientQueueSize(const std::uint32_t &value);
...
private:
    ...
    std::uint32_t maxClientQueueSize; /*!< The max number of client connections to queue */
};
