...
public class WKTPolygonHandler extends Handler {
    
    public WKTPolygonHandler() {
        
    }
    
    public WKTPolygonHandler create(Handler wktCompoundPointsHandler) {
        WKTPolygonHandler result = new WKTPolygonHandler();
