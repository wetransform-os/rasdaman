...
readonly TEST_2D_TIFF_3BANDS_FILE_PATH="$SCRIPT_DIR/../../30-wcstimport/testdata/001-3D_Timeseries_Regular/SCALED_M_LSTDA_2015-01.TIFF"
readonly TEST_2D_TIFF_1BAND_FILE_PATH="$SCRIPT_DIR/../../30-wcstimport/testdata/075-wcps_mean_summer_air_temp/mean_summer_airtemp.tif"
