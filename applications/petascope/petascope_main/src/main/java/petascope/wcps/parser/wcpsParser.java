...
public class wcpsParser extends Parser {
	...
	public static final int
		...
		ESCAPED_QUOTE=81, PLUS=82, POWER=83, REAL_PART=84, ROUND=85, RETURN=86, 
		RESOLUTION=87, RIGHT_BRACE=88, RIGHT_BRACKET=89, RIGHT_PARENTHESIS=90, 
		SCALE=91, SCALE_FACTOR=92, SCALE_AXES=93, SCALE_SIZE=94, SCALE_EXTENT=95, 
		SEMICOLON=96, SIN=97, SINH=98, SLICE=99, SOME=100, SORT=101, SQUARE_ROOT=102, 
		STRUCT=103, SUM=104, SWITCH=105, TAN=106, TANH=107, TRIM=108, TRUE=109, 
		USING=110, VALUE=111, VALUES=112, WHERE=113, XOR=114, POLYGON=115, LINESTRING=116, 
		MULTIPOLYGON=117, PROJECTION=118, WITH_COORDINATES=119, INTEGER=120, REAL_NUMBER_CONSTANT=121, 
		SCIENTIFIC_NUMBER_CONSTANT=122, POSITIONAL_PARAMETER=123, COVERAGE_VARIABLE_NAME=124, 
		COVERAGE_NAME=125, STRING_LITERAL=126, WS=127, EXTRA_PARAMS=128, ASTERISK=129;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SIN", "SINH", "SLICE", "SOME", "SORT", "SQUARE_ROOT", "STRUCT", "SUM", 
			"SWITCH", "TAN", "TANH", "TRIM", "TRUE", "USING", "VALUE", "VALUES", 
	...
	public final NumericalUnaryOperationContext numericalUnaryOperation() throws RecognitionException {
		...
		try {
			...
			setState(497);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 2533274792493120L) != 0) || ((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & 2147510273L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final TrigonometricOperatorContext trigonometricOperator() throws RecognitionException {
		...
		try {
			...
			setState(499);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 402711296L) != 0) || ((((_la - 97)) & ~0x3f) == 0 && ((1L << (_la - 97)) & 1539L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final UnaryArithmeticExpressionOperatorContext unaryArithmeticExpressionOperator() throws RecognitionException {
		...
		try {
			...
			setState(762);
			_la = _input.LA(1);
			if ( !(_la==ABSOLUTE_VALUE || _la==IMAGINARY_PART || ((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & 2147491841L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final WktPointsContext wktPoints() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==FALSE || _la==LEFT_PARENTHESIS || ((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & 39969721570820097L) != 0)) {
				{
				{
				setState(967);
				constant();
	...
	public final ReduceNumericalExpressionOperatorContext reduceNumericalExpressionOperator() throws RecognitionException {
		...
		try {
			...
			setState(1266);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 537002112L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 68719476739L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static final String _serializedATN =
		...
		"\u00d4\u00d6\u00d8\u00da\u00dc\u00de\u00e0\u00e2\u00e4\u00e6\u00e8\u00ea"+
		"\u0000\u0010\u0002\u0000\u0003\u0004WW\u0002\u0000..mm\u0003\u0000\f\f"+
		"MMrr\u0004\u0000++12BCJJ\u0002\u0000++JJ\u0003\u0000((GHRR\b\u0000\u0006"+
		"\u0006\u0015\u00150033GGRRTUff\u0005\u0000\b\t\r\u000f\u001b\u001cabj"+
		"k\u0002\u0000~~\u0080\u0080\u0005\u0000\u0006\u000633GGTTff\u0003\u0000"+
		",,??AA\u0002\u0000xx||\u0002\u0000\n\ndd\u0005\u0000\u0007\u0007\u0011"+
		"\u0011\u001d\u001dDEhh\u0005\u0000\f\fDEHHMMRR\u0002\u0000\u0010\u0010"+
		"\'\'\u0593\u0000\u00ec\u0001\u0000\u0000\u0000\u0002\u00f5\u0001\u0000"+
